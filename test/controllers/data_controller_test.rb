...
class DataControllerTest < ActionController::TestCase
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post :create, datum: { activity_id: @datum.activity_id, amount: @datum.amount, label: @datum.label }
    end
  ...
  test "should update datum" do
    patch :update, id: @datum, datum: { activity_id: @datum.activity_id, amount: @datum.amount, label: @datum.label }
    assert_redirected_to datum_path(assigns(:datum))
  end
