...
class OpportunitiesControllerTest < ActionController::TestCase
  ...
  test "should create opportunity" do
    assert_difference('Opportunity.count') do
      post :create, opportunity: { due_date: @opportunity.due_date, is_complete: @opportunity.is_complete, name: @opportunity.name, points: @opportunity.points, user_id: @opportunity.user_id }
    end
  ...
  test "should update opportunity" do
    patch :update, id: @opportunity, opportunity: { due_date: @opportunity.due_date, is_complete: @opportunity.is_complete, name: @opportunity.name, points: @opportunity.points, user_id: @opportunity.user_id }
    assert_redirected_to opportunity_path(assigns(:opportunity))
  end
